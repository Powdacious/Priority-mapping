...
export default function Home() {
  return (
    <main 
      className="flex min-h-screen flex-col items-center justify-between p-4 md:p-8"
      role="main"
      aria-label="Feature Priority Matrix Application"
    >
      <div className="w-full max-w-6xl mx-auto">
        ...
        <section 
          className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-lg p-4 mb-8 max-w-3xl mx-auto"
          aria-labelledby="who-is-this-for"
        >
          <h2 id="who-is-this-for" className="text-xl font-semibold mb-2">Who is this for?</h2>
          <p className="mb-2">
        ...
        <section aria-label="Feature Priority Matrix">
